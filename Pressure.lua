        ...
        autoloot = game:GetService("ProximityPromptService").PromptShown:Connect(function(prompt)
          for i, v in pairs(workspace.Rooms:GetDescendants()) do
            if v:IsA("Model") or v:IsA("Folder") then
              if v.Name == "ItemLocker" or v.Name == "Drawer" then
                if v:IsA("IntValue") and v.OpenValue.Value == false or v.Closed.Value == true then
                  fireproximityprompt(prompt)
                elseif v:IsA("IntValue") and v.OpenValue.Value == true or v.Closed.Value == false then
                  for _, v in ipairs(workspace.Rooms:GetDescendants()) do
                    if v:IsA("Model") then
